...
namespace FuncGenPlanilhas
{
    public class GenerateSpreadsheet
    {
        private readonly ILogger<GenerateSpreadsheet> _logger;

        public GenerateSpreadsheet(ILogger<GenerateSpreadsheet> logger)
        {
            _logger = logger;
        }
        ...
        void CreateSpreadsheetWorkbook(Stream stream)
        {
